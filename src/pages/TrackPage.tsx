...
export default function TrackPage({app}:{app:any}){
 ...
 return <div style={S.page}><Helmet><title>پیگیری ثبت‌نام | افرادیکید</title><meta name="description" content="وارد کردن کد پیگیری و مشاهده وضعیت ثبت‌نام دوره یا فرم مشاوره افرادیکید" /><meta name="robots" content="noindex, follow" /></Helmet><style>{css}</style><div style={{...S.card,maxWidth:460}}><h2 style={{color:T.ttl,fontSize:18,marginTop:0}}>{lang==='en'?'Track your registration':'پیگیری ثبت‌نام'}</h2><p style={{color:T.mut,fontSize:12,lineHeight:1.9}}>{lang==='en'?'Enter your tracking code and the phone number used at registration.':'کد پیگیری و شماره تماسی که هنگام ثبت وارد کردید را وارد کنید.'}</p>
