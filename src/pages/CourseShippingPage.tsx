...
export default function CourseShippingPage(){
 ...
 return <div dir={lang==='en'?'ltr':'rtl'} style={S.page}><Helmet><title>ثبت‌نام دوره | فرزند من</title><meta name="description" content="تکمیل ثبت‌نام دوره تخصصی رشد و تغذیه کودکان و نوجوانان" /><meta name="robots" content="noindex, follow" /></Helmet><style>{css}</style><div style={{...S.card, paddingTop:'10px'}}>
  <form
