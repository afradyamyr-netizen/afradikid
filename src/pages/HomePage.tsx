...
export default function HomePage(){
 ...
 const shortcutsBase:Record<string,{icon:React.ReactNode;title:string;desc:string;to?:string;fn?:()=>void;accent?:boolean}>={
  consult:{accent:true,icon:<ConsultIcon size={24} color={T.acc}/>,title:lang==='en'?'Request consultation':'ثبت درخواست مشاوره',desc:lang==='en'?'A clear first step for your child':'قدم اول برای شناخت بهتر شرایط فرزند',fn:()=>requestConsult?.()},
 ...
 return <main className="zk-home-page zk-home-v2" dir={isRtl?'rtl':'ltr'} style={{...app.S?.page,paddingBottom:92,flexDirection:'column',alignItems:'center',background:T.bg,color:T.txt,overflowX:'hidden'}}>
  <Helmet><title>{`${brand} | مشاوره رشد و تغذیه کودکان و نوجوانان`}</title><meta name="description" content="مشاوره تخصصی و آموزش والدین درباره رشد قد، تغذیه، اشتها، وزن و تمرکز کودک و نوجوانان؛ با رویکردی مادرانه و علمی."/><meta name="keywords" content="رشد قد کودک, تغذیه کودک, بی‌اشتهایی کودک, بدغذایی, مشاوره رشد کودک, مشاوره تغذیه کودک"/><meta property="og:title" content={`${brand} | مشاوره رشد و تغذیه کودکان و نوجوانان`}/><meta property="og:description" content="مشاوره تخصصی و آموزش والدین درباره رشد قد، تغذیه، اشتها، وزن و تمرکز کودک و نوجوانان؛ با رویکردی مادرانه و علمی."/></Helmet>
