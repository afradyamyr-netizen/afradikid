      ...
      <div style={{ marginBottom: 14, padding: 12, borderRadius: 12, background: T.soft, border: `1px solid ${T.brd}` }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          <div>
            ...
            <textarea style={S.ta} rows={2} defaultValue={referral.texts?.homeBase || ''} onBlur={(e) => setReferralText('homeBase', e.target.value)} />
          </div>
          <div>
            <label style={S.lbl}>پیام راهنما در صفحهٔ هوم (لینک تب دوره)</label>
            <textarea style={S.ta} rows={2} defaultValue={referral.texts?.homeTab || ''} onBlur={(e) => setReferralText('homeTab', e.target.value)} />
          </div>
          <div>
            <label style={S.lbl}>پیام راهنما در صفحهٔ هوم (لینک دورهٔ مشخص)</label>
            <textarea style={S.ta} rows={2} defaultValue={referral.texts?.homeCourse || ''} onBlur={(e) => setReferralText('homeCourse', e.target.value)} />
          </div>
          <div>
            <label style={S.lbl}>پیام راهنما در صفحهٔ معرفی دوره‌ها (لینک تب دوره)</label>
            <textarea style={S.ta} rows={2} defaultValue={referral.texts?.coursesTab || ''} onBlur={(e) => setReferralText('coursesTab', e.target.value)} />
          </div>
          <div>
            <label style={S.lbl}>پیام راهنما در صفحهٔ معرفی دوره‌ها (لینک دورهٔ مشخص)</label>
            <textarea style={S.ta} rows={2} defaultValue={referral.texts?.coursesCourse || ''} onBlur={(e) => setReferralText('coursesCourse', e.target.value)} />
          </div>
          <div>
            <label style={S.lbl}>متن پیام پاپ‌آپ «درخواست مشاورهٔ مجدد»</label>
            <textarea style={S.ta} rows={2} defaultValue={referral.texts?.popupTitle || ''} onBlur={(e) => setReferralText('popupTitle', e.target.value)} />
          </div>
          <div>
            <label style={S.lbl}>عنوان دکمهٔ اصلی پاپ‌آپ (لینک پایه)</label>
            <input style={S.inp} defaultValue={referral.texts?.popupPrimaryBase || ''} onBlur={(e) => setReferralText('popupPrimaryBase', e.target.value)} />
          </div>
          <div>
            <label style={S.lbl}>عنوان دکمهٔ اصلی پاپ‌آپ (لینک تب دوره)</label>
            <input style={S.inp} defaultValue={referral.texts?.popupPrimaryTab || ''} onBlur={(e) => setReferralText('popupPrimaryTab', e.target.value)} />
          </div>
          <div>
            <label style={S.lbl}>عنوان دکمهٔ اصلی پاپ‌آپ (لینک دورهٔ مشخص)</label>
            <input style={S.inp} defaultValue={referral.texts?.popupPrimaryCourse || ''} onBlur={(e) => setReferralText('popupPrimaryCourse', e.target.value)} />
          </div>
          <div>
            <label style={S.lbl}>عنوان دکمهٔ «مجدداً درخواست مشاوره دارم»</label>
            <input style={S.inp} defaultValue={referral.texts?.reconsultLabel || ''} onBlur={(e) => setReferralText('reconsultLabel', e.target.value)} />
          </div>
          <div>
            <label style={S.lbl}>سؤال «به چه دلیلی مجدداً درخواست مشاوره دارید؟»</label>
            <input style={S.inp} defaultValue={referral.texts?.reconsultQuestion || ''} onBlur={(e) => setReferralText('reconsultQuestion', e.target.value)} />
          </div>
        </div>
      </div>
