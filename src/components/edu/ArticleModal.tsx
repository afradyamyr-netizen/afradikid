      ...
      <div className="zke-modal-win">
        ...
        <div className="zke-article">
          <div className="zke-article-meta">
            ...
            <span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><circle cx="12" cy="8" r="3.4" /><path d="M5 20c.7-3.8 3.4-6 7-6s6.3 2.2 7 6" /></svg>{en ? 'Farzandman care team' : 'تیم همراهی فرزند من'}</span>
