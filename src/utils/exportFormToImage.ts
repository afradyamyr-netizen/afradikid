...
export async function generateFormImage(submission: any, format: 'webp' | 'jpg' = 'webp'): Promise<Blob> {
  ...
  ctx.font=F_SUB;ctx.fillStyle='rgba(255,255,255,.92)';ctx.fillText('فرزند من  |  پرونده محرمانه والد و کودک',width-pad-34,134);
  ...
  ctx.textAlign='center';ctx.font=F_FOOTER;ctx.fillStyle='#789395';ctx.fillText('فرزند من — همراهی والدین در مسیر رشد و تغذیه کودک',width/2,height-46);
