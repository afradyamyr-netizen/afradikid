const fa = {
  ...
  homeFAQTitle: 'سوالات متداول', faqPageTitle: 'سوالات متداول | فرزند من', faqPageDesc: 'پاسخ به سوالات متداول درباره رشد قد، بی‌اشتهایی، بدغذایی، تقویت هوش و سلامت کودکان', viewAllFAQs: 'مشاهده همه سوالات', noFAQs: 'هیچ سوالی ثبت نشده است.',
  ...
  coursesSeoFullTitle: 'درباره دوره‌های فرزند من',
