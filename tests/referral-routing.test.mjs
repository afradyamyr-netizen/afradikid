...
for(const token of ['min-height:100dvh','min-height:92dvh','overflow-y:auto','border-radius:38px','border-radius:9999px','-webkit-tap-highlight-color:transparent','background:#0F1A19','linear-gradient(90deg,#1769c2 0%,#356b62 100%)','color:#1769C2','color:#0F1722','id="neu-4-shadow"','id="donut-shadow"','id="donut-hole-mask"'])if(!static404.includes(token))throw new Error(`Static 404 contract missing: ${token}`);
