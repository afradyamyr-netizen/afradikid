...
if(static404.includes('<script')||static404.includes('zk_design_system')||static404.includes('/functions/v1/public-settings'))throw new Error('Static 404 should use the safe project palette without scripts or network bootstrap.');
