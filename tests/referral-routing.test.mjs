...
for(const token of ['min-height:100dvh','min-height:92dvh','overflow-y:auto','border-radius:38px','border-radius:9999px','-webkit-tap-highlight-color:transparent','background:#f8fafc','linear-gradient(90deg,#6b21a8 0%,#db2777 100%)','color:#BE3A31','color:#312E55','id="neu-4-shadow"','id="donut-shadow"','id="donut-hole-mask"'])if(!static404.includes(token))throw new Error(`Static 404 contract missing: ${token}`);
