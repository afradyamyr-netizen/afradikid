...
| # | مورد | وضعیت | پیش‌نیاز |
|---|---|---|---|
| ۱ | جدول `phone_tracking_codes` (یک کد پیگیری برای هر شماره) | ❌ **معوق** — اولویت بالا | کلید Management یا دسترسیِ SQL |
| ۲ | انتشارِ دوبارهٔ Edge Function «پرداخت» (حذف کپچا) | ❌ **معوق** | کلید Management |
| ۲-الف | بررسیِ وضعیتِ انتشارِ بقیهٔ Edge Functionها | ⬜ بررسی‌نشده | کلید Management |

> **یادداشتِ ۲۰۲۶-۰۹-۱۷:** کلید Management با مقدار `sbp_fce49cde…` **دوباره آزمایش شد**؛
...
| آزمون | نتیجه |
|---|---|
| `GET /v1/projects/doikoqzarsuprcwkghsq` با کلید `sbp_fce49cde…` | **HTTP ۴۰۳** — «account does not have the necessary privileges» |
