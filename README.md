...
## معرفی  
افرادیکید پلتفرم مشاوره و آموزش آنلاین برای والدین  
کودکان ۲ تا ۱۷ سال است. شامل دو اپلیکیشن:  
  
- **afradikid-main**: سایت اصلی (صفحات عمومی، دوره‌ها، پنل مدیریت)  
- **afradikid-form**: فرم مشاوره (ثبت‌نام و اطلاعات فرزند)  
