-- ==============================================================================
-- AFRADIKID PLATFORM (افرادیکید) — MASTER SUPABASE SQL SCHEMA (Stage 11 / v5.0)
...
CREATE TABLE IF NOT EXISTS public.settings (
    ...
    site_title VARCHAR(150) DEFAULT 'افرادیکید',
    browser_title VARCHAR(200) DEFAULT 'فرم مشاوره افرادیکید',
    specialist_name VARCHAR(150) DEFAULT 'کارشناس رشد و تغذیه کودک و نوجوان افرادیکید',
